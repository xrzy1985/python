...
# Objects and Classes with Polymorphism
...
copy real world objects into a computer setting using classes.
    ...
    polymorphism allows you to refer to objects as their super class
and then automatically have the correct functions called on the fly
...
class Dog(Animal):
    ...
    def multiple_sounds(self, how_many_sounds=None):
...
# i forgot to show how the multipl_sounds function works
buster.multiple_sounds(4)
buster.multiple_sounds()

# polymorphism allows you to refer to objects as their super class
# and then automatically have the correct functions called on the fly

class AnimalTesting:
    # create a function to take animal objects
    def get_type(self, animal):
        animal.get_type()


# create a test object of type AnimalTesting
test = AnimalTesting()

test.get_type(buster)
test.get_type(cat)
test.get_type(bird)
